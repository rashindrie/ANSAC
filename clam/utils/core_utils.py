...
from sklearn.metrics import roc_auc_score, roc_curve, f1_score, confusion_matrix, multilabel_confusion_matrix
...
def calc_metrics(true_batch_labels, pred_batch_labels, classes=[0, 1]):
    ...
    return sensitivity, specificity, f1, balanced_accuracy, weighted_accuracy
...
def train(datasets, cur, args, save=True):
    """   
...
def train_loop_clam(epoch, model, loader, optimizer, n_classes, bag_weight, writer = None, loss_fn = None):
    ...
    sensitivity, specificity, f1, balanced_accuracy, weighted_accuracy = calc_metrics(actuals, predictions, classes=list(range(n_classes)))
    print(f"Epoch: [{epoch}] \tsensitivity: {sensitivity} \tspecificity: {specificity} \tbalanced_acc: {balanced_accuracy} \tweighted_acc: {weighted_accuracy}")

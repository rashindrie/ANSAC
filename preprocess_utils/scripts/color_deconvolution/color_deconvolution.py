"""Placeholder."""
from preprocess_utils.scripts import color_conversion
import preprocess_utils.scripts.utils as utils
from ._linalg import normalize
from .complement_stain_matrix import complement_stain_matrix
import collections
import numpy as np
from preprocess_utils.scripts.color_deconvolution.stain_color_map import (
    stain_color_map)
from preprocess_utils.scripts.color_deconvolution.find_stain_index import (
    find_stain_index)
from preprocess_utils.scripts.color_deconvolution.\
...
def color_deconvolution(im_rgb, w, I_0=None):
    ...
    See Also
    --------
    histomicstk.scripts.color_deconvolution.complement_stain_matrix,
    histomicstk.scripts.color_deconvolution.color_convolution
    histomicstk.scripts.color_conversion.rgb_to_od
    histomicstk.scripts.color_conversion.od_to_rgb
    histomicstk.scripts.color_conversion.rgb_to_sda
    histomicstk.scripts.color_conversion.sda_to_rgb
...
def _reorder_stains(W, stains=None):
    ...
    histomicstk.scripts.color_deconvolution.find_stain_index
...
def stain_unmixing_routine(
    ...
    See Also
    --------
    histomicstk.scripts.color_deconvolution.separate_stains_macenko_pca
    histomicstk.scripts.color_deconvolution.separate_stains_xu_snmf
...
def color_deconvolution_routine(
    ...
    See Also
    --------
    histomicstk.scripts.color_deconvolution.stain_unmixing_routine
    histomicstk.scripts.color_deconvolution.color_deconvolution

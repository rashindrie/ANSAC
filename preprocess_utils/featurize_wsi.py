...
from preprocess_utils.encode_utils import WsiNpySequence, predict_generator, plot_feature_map, compute_single_distance_map
...
def encode_augment_wsi_batch(wsi_pattern, encoder, output_dir, code_size, batch_size, aug_modes, save_features, overwrite=False):
